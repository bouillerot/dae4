...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $stateMachineItem->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $stateMachineItem->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="stateMachineItems form content">
            ...
            <fieldset>
                <legend><?= __('Edit State Machine Item') ?></legend>
                <?php
